...
if len(sys.argv) > 1:
    ...
    lane_data_file = "./test_data/lane_data.0.txt"
...
plt.axis('equal')
plt.plot(x, y, 'g-', label='smoothed traj')
...
plt.subplot(2, 1, 1)
plt.axis('equal')
plt.plot(x, y, 'r-', label='HybridAstar traj')
plt.legend(loc='upper left')
# plt.plot(x, kappa, 'r--')
...
# plt.plot(x, theta)
plt.axis('equal')
plt.plot(x, kappa, 'r-', label='HybridAstar kappa')
plt.legend(loc='upper left')
