...
double ComputeTheta(const std::vector<double> &coefs_x_d, const std::vector<double> &coefs_y_d, double t) {
    double x_d_t = CoefsApply(coefs_x_d, t);
    double y_d_t = CoefsApply(coefs_y_d, t);
    return std::atan2(y_d_t, x_d_t);
}

double ComputeKappa(const std::vector<double> &coefs_x_d, const std::vector<double> &coefs_x_dd,
                    const std::vector<double> &coefs_y_d, const std::vector<double> &coefs_y_dd, double t) {
    double x_d_t = CoefsApply(coefs_x_d, t);
    double y_d_t = CoefsApply(coefs_y_d, t);
